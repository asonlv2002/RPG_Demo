...
namespace JohnStairs.RCC.Character.MMO {
    ...
    public class RPGCameraMMO : RPGCamera {
        ...
        /// <summary>
        /// InitLate the Rotate rotation euler angles for a turning routine depending on the turning rotation which should be performed
        /// </summary>
        /// <param name="rotationAxes">Rotation axes which should be considered</param>
        /// <returns>The Rotate rotation in euler angles</returns>
