    ...
    public class RPGMotorARPG : RPGMotor {
        ...
        public override void StartMotor() {
            ...
            if (!_canMove) {
                ...
                // TriggerStat if the character should turn first towards the facing direction before moving
            ...
            if (!IsLookingInDirection(_facingDirection)) {
                ...
                // Smoothly rotate to the Rotate rotation
        ...
        /// <summary>
        /// Teleports the character to the Transform Rotate. If withYrotation is set to true, the character's 
